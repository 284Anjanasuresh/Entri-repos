...
(1,101,'Lower Parel',9987650943),
(2,102,'Bansi Homie',7650983211),
(3,103,'Express Towers',6574987322),
(4,104,'Jolly Maker',9977664422),
(5,105,'Hornimon Circle',7789432312),
(6,106,'Anna Salai',9123508764),
(7,107,'Raheja Chambers',7032458798),
(8,108,'Cuffe Parade',7982345677),
(9,109,'Pingle Chowk',9160872569),
(10,110,'Tamaring Lane',8015789023);
...
(1,'John','Manager',65000,1),
(2,'David','Library Assistant',55000,2),
(3,'William','Library Clerk',55000,2),
(4,'Richard','Librarian',70000,2),
(5,'Christopher','Senior Librarian',70000,2),
(6,'Charles','Research Assistant',75000,2),
(7,'Daniel','Director',45000,2),
(8,'Donald','Customer Service',40000,4),
(9,'Mark','Cashier',30000,5),
(10,'Andrew','Library Staff',35000,6);
...
(1,'Robert','Brockton Avenue','2023-01-17'),
(2,'Susan','Oak Street','2023-02-21'),
(3,'Sarah','Timpany Blvd','2023-09-25'),
(4,'Lisa','Pleasant Valley Street','2023-03-08'),
(5,'Steven','Russell St','2023-11-19'),
(6,'Nancy','Lynnway villa','2023-05-11'),
(7,'Sandra','Plymount Street','2023-06-06'),
(8,'Donna','Hubbard Ave','2023-06-18'),
(9,'Paul','Rose Villa','2021-06-26'),
(10,'Margaret','Thruway Plaza','2021-12-04');
